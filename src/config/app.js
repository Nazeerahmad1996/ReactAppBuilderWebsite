...
defaultExport.adminConfig={
  ...
  "fieldsTypes":{
    ...
    "relation":['creator','collection','collection_news','collection_recipe','radios_collection','collection_eventsconference','collection_event','eventsnc_collection','collection_product'],
    "iconmd":['iconmd'],
    "iconfa":['iconfa'],
    "iconti":['iconti'],
    "iconfe":['icon'],
  ...
  "optionsForRelation":[
    //'collection','collection_news','collection_recipe','radios_collection','collection_eventsconference','collection_event','eventsnc_collection','collection_product'
    {
      "display": "title",
      "key": "collection",
...
defaultExport.licenseCode="d4178af7-6ca3-4f40-bdbd-f6bff6f99673";//Envato purchase code.
