       ...
       <div className="main-panel" style={{ width: '100%'}}>
        ...
        <div className="container-fluid">
            ...
            <Tile 
              ...
              isIcon={true}
              subTitle={"Create app from template"}
              title={"New app"}
            ...
            <SkyLight
                ...
                <ConditionalDisplay condition={this.state.appsAllowed === 0}>
                    <div className="row">
                        <div className="col-md-12">
                            <hr />
                            <p> You don't have any Subscription Plan.</p>
                            <p> Please Purchase now.</p>
                            <hr />
                        </div>
                    </div>
                </ConditionalDisplay>
                <ConditionalDisplay condition={this.state.appsMade === this.state.appsAllowed&&this.state.appsAllowed!=0}>
                    <div className="row">
                        <div className="col-md-12">
                            <hr />
                            <p> You have reach the limit for maximum apps. </p>
                            <p> Please update your Subscription Plan.</p>
                            <hr />
                        </div>
                    </div>
                </ConditionalDisplay>
            ...
            <SkyLight
                ...
                <ConditionalDisplay condition={!this.licenseCodeValidation()}>
                    <div className="row">
                        <div className="col-md-12">
                            <hr />
                            <p> You don't have Item Purchase Code or your Item Purchase Code is not valid. </p>
                            <p> Please update your Item Purchase Code. </p>
                            <hr />
                        </div>
                    </div>
                </ConditionalDisplay>
        ...
        <footer className="footerfa" style={{'padding-top': '24%'}}></footer>
       </div>     
        )
    }
}
