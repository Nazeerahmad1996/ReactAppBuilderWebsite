 ...
 licenseCodeValidation(){
  ...
  checkAppCreate(){
      if(this.state.name<3){
          alert("App name missing")
      }else if(this.state.id<3){
        alert("App package id missing");
      }else{
          this.endStep();
      }
  }
  ...
  createStep3Content(){
      ...
      <div className="col-sm-8">
          ...
          <button onClick={this.checkAppCreate} className={Config.designSettings.submitButtonClass}>Create app</button>
                    ...
                    <div className="row">
                        <div className="col-md-8 col-md-offset-2">
                            ...
                            <ConditionalDisplay condition={this.state.appsAllowed === 0}>
                                <div className="row">
                                    <div className="col-md-12">
                                        <h3> You don't have any Subscription Plan.</h3>
                                        <h3> Please Purchase now.</h3>
                                    </div>
                                    <div className="col-md-11 col-md-offset-1">
                                        <Link type="submit" className={"pull-right btn "+Config.designSettings.submitButtonClass} to="/billing">Purchase now</Link>
                                    </div>
                                </div>
                            </ConditionalDisplay>
                            <ConditionalDisplay condition={this.state.appsMade === this.state.appsAllowed&&this.state.appsAllowed!=0}>
                                <div className="row">
                                    <div className="col-md-12">
                                        <h3> You have reach the limit for maximum apps.</h3>
                                        <h3> Please update your Subscription Plan.</h3>
                                    </div>
                                    <div className="col-md-11 col-md-offset-1">
                                        <Link type="submit" className={"pull-right btn "+Config.designSettings.submitButtonClass} to="/billing">Purchase now</Link>
                                    </div>
                            ...
                            <ConditionalDisplay condition={!this.licenseCodeValidation()}>
                                <div className="row">
                                    <div className="col-md-12">
                                        <h3> You don't have Item Purchase Code or your Item Purchase Code is not valid.</h3>
                                        <h3> Please update your Item Purchase Code.</h3>
                                    </div>
                                </div>
                            </ConditionalDisplay>
                            </Card>
                    ...
                    <div className="container-fluid">
                        ...
                        <Wizzard 
                            ...
                            steps={[
                            {
                                ...
                                icon:"flip_to_front",
                                title:"Template",
                                label1:"Select the app type",
                                label2:"What kind of app you will make?",
                                content:this.createStep1Content()
                            },{
                                name:"layout",
                                icon:"drag_indicator",
                                title:"Layout",
                                label1:"Select the app layout",
                                label2:"What kind of app you will make?",
                            ...
                            },
                            {
                                ...
                                title:"Overview",
                                label1:"Confirm selected and entered data",
                                label2:"All informations are required",
